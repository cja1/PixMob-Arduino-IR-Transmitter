...
//Run Length Encoded unsigned short uint8_t array, so 1,1,0,0,0,1,1,1,0 => {2,3,3,1,kEndFlag}
void Command::convertToRLE(uint8_t* runLengths) {
  uint8_t runCount = 0;
  ...
  //Add end flag
  runLengths[runCount] = kEndFlag;
}

//Debug tool
void Command::printUIntArray(String label, uint8_t array[], uint8_t size) {
...
void CommandSingleColorExt::createRLE(uint8_t* runLengths) {
  ...
  Command::encode();
  Command::convertToRLE(runLengths);
}
...
void CommandSetColor::createRLE(uint8_t* runLengths) {
  ...
  encode();
  convertToRLE(runLengths);
}

void CommandSetColor::createStartColorRLE(uint8_t _red, uint8_t _green, uint8_t _blue, uint8_t _profileId, uint8_t* runLengths) {
  red = _red;
  green = _green;
  blue = _blue;
...
void CommandSetConfig::createRLE(uint8_t* runLengths) {
...
void CommandSingleColor::createRLE(uint8_t* runLengths) {
...
void CommandTwoColor::createRLE(uint8_t* runLengths) {
...
void CommandSetRepeatDelayTime::createRLE(uint8_t* runLengths) {
...
void CommandSetRepeatCount::createRLE(uint8_t* runLengths) {
